...
**Adjunct (v0 docs):** Mac + Ollama + Dropbox test library → Pi HTTP player — [music-agent-orchestration/README.md](music-agent-orchestration/README.md). **V0.0 (simplified Pi player, Mac browser / curl, tests, add tracks):** [music-agent-orchestration/v0_0/OPERATORS.md](music-agent-orchestration/v0_0/OPERATORS.md). **V0.1 (landing page, local catalog + IPC playback meter, port 8766):** [music-agent-orchestration/v0_1/OPERATORS.md](music-agent-orchestration/v0_1/OPERATORS.md). **V0.2 (Pi + Lambda presign + S3 playback, port 8767):** [music-agent-orchestration/v0_2/OPERATORS.md](music-agent-orchestration/v0_2/OPERATORS.md). **Phased roadmap + HLS/DASH scope notes:** [music-agent-orchestration/docs/roadmap.md](music-agent-orchestration/docs/roadmap.md), [music-agent-orchestration/docs/streaming-notes.md](music-agent-orchestration/docs/streaming-notes.md).
