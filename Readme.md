...
**Adjunct (v0 docs):** Mac + Ollama + Dropbox test library → Pi HTTP player — [music-agent-orchestration/README.md](music-agent-orchestration/README.md). **V0.0 (simplified Pi player, Mac browser / curl, tests, add tracks):** [music-agent-orchestration/v0_0/OPERATORS.md](music-agent-orchestration/v0_0/OPERATORS.md).
