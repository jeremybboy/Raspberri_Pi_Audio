...
| User Rules **text to paste** | [docs/cursor-user-rules-paste.md](cursor-user-rules-paste.md) (canonical block for Cursor Settings) |
| Repo mirror of those defaults | `.cursor/rules/collaboration-defaults.mdc` (when this repo is the workspace) |

## User Rules block (paste + repo mirror)

- **Paste into Cursor:** follow [docs/cursor-user-rules-paste.md](cursor-user-rules-paste.md) — same expectations as account-wide User Rules.
- **Already in the repo:** [`.cursor/rules/collaboration-defaults.mdc`](../.cursor/rules/collaboration-defaults.mdc) with `alwaysApply: true` keeps the model aligned when this folder is the workspace; keep it in sync with the paste doc when you change wording.
